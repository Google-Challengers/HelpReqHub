    ...
    <>
      <div className="flex flex-col items-start bg-white rounded-lg p-2 m-1">
        ...
        <div className="flex flex-row">
          <button
            type="button"
            className="p-2 rounded-lg bg-green-500 text-white font-semibold text-base mx-1"
          >
            Accept
          </button>
          <button
            type="button"
            className="p-2 rounded-lg bg-red-500 text-white font-semibold text-base mx-1"
          >
            Reject
          </button>
        </div>
